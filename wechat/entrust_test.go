...
func TestClient_EntrustPublic(t *testing.T) {
	...
	// 公众号纯签约
	wxRsp, _, err := client.EntrustPublic(context.Background(), bm)
	if err != nil {
...
func TestClient_EntrustAppPre(t *testing.T) {
	...
	// APP纯签约
	wxRsp, _, err := client.EntrustAppPre(context.Background(), bm)
	if err != nil {
...
func TestClient_EntrustH5(t *testing.T) {
	...
	// H5纯签约
	wxRsp, _, err := client.EntrustH5(context.Background(), bm)
	if err != nil {
