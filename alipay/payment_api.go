...
func (a *Client) TradeOrderPrecreate(bm gopay.BodyMap) (aliRsp *TradeOrderPrecreateRsp, err error) {
	...
	aliRsp = new(TradeOrderPrecreateRsp)
	if err = json.Unmarshal(bs, aliRsp); err != nil {
		return nil, err
	}
	if aliRsp.Response != nil && aliRsp.Response.Code != "10000" {
...
func (a *Client) TradeItemorderBuy(bm gopay.BodyMap) (aliRsp *TradeItemorderBuyRsp, err error) {
	...
	aliRsp = new(TradeItemorderBuyRsp)
	if err = json.Unmarshal(bs, aliRsp); err != nil {
		return nil, err
	}
	if aliRsp.Response != nil && aliRsp.Response.Code != "10000" {
