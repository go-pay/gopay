...
func (a *Client) AntMerchantShopModify(bm gopay.BodyMap) (aliRsp *AntMerchantExpandShopModifyRsp, err error) {
	var bs []byte
...
func (a *Client) AntMerchantShopCreate(bm gopay.BodyMap) (aliRsp *AntMerchantExpandShopCreateRsp, err error) {
...
func (a *Client) AntMerchantShopConsult(bm gopay.BodyMap) (aliRsp *AntMerchantExpandShopConsultRsp, err error) {
	err = bm.CheckEmptyError("business_address", "shop_category", "store_id", "shop_type", "ip_role_id", "shop_name")
	if err != nil {
		return nil, err
	}
