...
func TestTradeOrderPrecreate(t *testing.T) {
	...
	aliRsp, err := client.TradeOrderPrecreate(bm)
	if err != nil {
		xlog.Errorf("client.TradeOrderPrecreate(%+v),error:%+v", bm, err)
		return
	}
	xlog.Debug("aliRsp:", *aliRsp)
}
...
func TestTradeItemorderBuy(t *testing.T) {
	...
	aliRsp, err := client.TradeItemorderBuy(bm)
	if err != nil {
		xlog.Errorf("client.TradeItemorderBuy(%+v),error:%+v", bm, err)
		return
	}
	xlog.Debug("aliRsp:", *aliRsp)
}